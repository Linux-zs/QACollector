  ...
  async function loadTerms() {
    ...
    try {
      ...
      if (searchQ.trim()) {
        ...
        data = await api.filterTerms({ category: selectedCategory, limit: 100 });
      } else {
    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="flex flex-wrap gap-3 mb-6">
        ...
        {(searchQ || selectedCategory) && (
          <button onClick={() => { setSearchQ(''); setSelectedCategory(''); }} className="px-3 py-2 text-sm text-gray-500 hover:text-gray-700">
            清除筛选
          </button>
        )}
